...
// Fetch all bookings without filtering by the current date
$bookingQuery = "SELECT booking.*, users.First_Name AS agent_first_name, users.Last_Name AS agent_last_name
    FROM booking 
    LEFT JOIN users ON booking.agent_id = users.Id
    WHERE booking.paid_cash != 0";
$bookingStatement = $pdo->prepare($bookingQuery);
$bookingStatement->execute();
$bookings = $bookingStatement->fetchAll(PDO::FETCH_ASSOC);

try {
    // Fetch data from the expense table including the assignment names
    ...
    // Fetch data from the income table including the assignment names
...
<h2 class="my-20 text-center">Ümumi Kassa</h2>
                        ...
                        <tbody>
                            ...
                            <tr class="<?php echo ($index % 2 == 0) ? 'even-row' : 'odd-row'; ?>">
                                ...
                                <td style="text-align:center">
                                    ...
                                    <form action="cashier-delete-income.php" method="post">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr class="<?php echo ($index % 2 == 0) ? 'even-row' : 'odd-row'; ?>">
                                    ...
                                    <td style="text-align:center">
                                        <!-- Remove button with Form -->
                                        <form action="cashier-delete-expense.php" method="post">
