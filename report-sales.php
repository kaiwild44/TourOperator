...
// Adjust the SQL statement to select only users with the 'Promoter' role and bookings within the specified date range if provided
$sql = "SELECT 
            u.Id, 
            u.First_Name, 
            u.Last_Name, 
        ...
        <table class="table font-small-8">
            <thead>
                <tr>
                    ...
                    <th>Sales</th>
                    <th>Total</th>
                    <th>Net Price</th> <!-- New column header -->
                </tr>
            </thead>
            <tbody>
                <?php $sn = 1; ?>
